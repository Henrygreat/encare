...
import { CloudOff, Eye, EyeOff, Mail, LockKeyhole, ArrowRight } from 'lucide-react'
  ...
  return (
    <AuthShell
      ...
      footer={
        <div className="space-y-3 text-center text-sm text-slate-600">
          ...
          <Link href="/demo" className="inline-flex items-center gap-2 font-medium text-primary-700 hover:text-primary-800">
    ...
    >
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <Button type="submit" fullWidth size="tap" isLoading={isLoading} disabled={!isOnline}>
          Sign in
        </Button>
      </form>
    </AuthShell>
